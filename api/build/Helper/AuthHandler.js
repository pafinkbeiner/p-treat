...
exports.register = exports.login = exports.allowAdmin = exports.allowPremium = exports.allowCustomer = void 0;
                ...
                case 4:
                    if (user != undefined) {
                        if (bcrypt_1.default.compareSync(password, user.password)) {
                            return [2 /*return*/, { key: jsonwebtoken_1.default.sign(user, process.env.JWT_SECRET || "") }];
                        }
                    }
                    else {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, User_1.default.findOne({ mail: mail })];
                case 2:
                    if (_b.sent()) {
                        found = true;
                    }
                ...
                case 4:
                    ...
                    user.save()
                        .then(function (result) { return login(mail, password); })
