...
exports.register = exports.login = exports.allowAdmin = exports.allowPremium = exports.allowCustomer = exports.extractBearerToken = void 0;
...
function allowPremium(req, res, next) {
    var bearer = req.headers["authorization"];
    if (bearer != undefined) {
        var token = bearer.split(" ")[1];
        jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET || "", function (err, authData) {
...
exports.allowPremium = allowPremium;
                ...
                case 1:
                    ...
                    if (user != undefined) {
                        if (bcrypt_1.default.compareSync(password, user.password)) {
                            return [2 /*return*/, { key: jsonwebtoken_1.default.sign(user.toJSON(), process.env.JWT_SECRET || "") }];
                        }
                    }
                    else {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, User_1.default.findOne({ email: email })];
                case 1:
                    found = (_a.sent()) != undefined ? true : false;
                    if (found)
                        return [2 /*return*/, undefined];
                ...
                case 2:
                    result = _a.sent();
                    if (result != undefined) {
                        return [2 /*return*/, login(result.email, password)];
                    }
                    else {
                        return [2 /*return*/, undefined];
                    }
